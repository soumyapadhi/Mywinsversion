...
export default function Oneview() {
  ...
  const regionOptions = (
    <Select labelId="region-label" value={ub} onChange={handleChange}>
      {REGION.map((record) => (
        <MenuItem value={record.ub}>{record.site}</MenuItem>
      ))}
    </Select>
  );
        ...
        <Grid container xs={12} sm={4}>
          ...
          <FormControl className={classes.formControl}>
            ...
            >
              ...
              <MenuItem value={1000}>1 Seconds</MenuItem>
