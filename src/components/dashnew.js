...
class DashNew extends React.Component {
  render() {
    ...
    return (
      <div>
        <h1 id="head1">Hi</h1>
        <button className={classes.root} type="button" onClick={increase}>
          Refresh me!
        </button>
        ...
        <FormControl className={classes.formcntl}>
          ...
          >
            <MenuItem className={classes.mstyle} value={30000}>
              Refresh in 30 Seconds
            </MenuItem>
            <MenuItem className={classes.mstyle} value={5000}>
              Refresh in 5 Seconds
            </MenuItem>
            <MenuItem className={classes.mstyle} value={1000}>
              Refresh in 1 Seconds
            </MenuItem>
            <MenuItem className={classes.mstyle} value={2000}>
              Refresh in 2 Seconds
            </MenuItem>
            <MenuItem className={classes.mstyle} value={60000}>
              Refresh in 1 Minute
            </MenuItem>
            <MenuItem className={classes.mstyle} value={120000}>
              Refresh in 2 Minutes
            </MenuItem>
            <MenuItem className={classes.mstyle} value={180000}>
              Refresh in 3 Minutes
            </MenuItem>
            <MenuItem className={classes.mstyle} value={240000}>
              Refresh in 4 Minutes
            </MenuItem>
            <MenuItem className={classes.mstyle} value={300000}>
