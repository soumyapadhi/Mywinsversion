  ...
  const drawer = (
    <React.Fragment>
      ...
      <List component="nav">
       ...
       <ListItemText className={classes.listcolor} primary="Home" />
       </ListItem>
       <ListItem button divider onClick={handleClick}>
         <ListItemText className={classes.listcolor} primary="Test Region" />
       </ListItem>
       ...
       <List component="div" disablePadding>
         ...
         <ListItem button className={classes.nested} onClick={() => setOpenDrawer(false)}
          component={Link} to="/GMP"
          >
           <ListItemText primary="GMP Dashboard" />
         </ListItem>
       </List>
       </Collapse>
     </List>
